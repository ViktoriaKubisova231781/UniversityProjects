...
output_filename = "test_definitions_prompt.csv"
...
# Function to analyze emotions in text with detailed definitions
def analyze_emotion(text):
    # Prompt with detailed definitions
    prompt = """Analyze the following sentence and classify its emotional content as one of these emotions: 

1. Happiness: A feeling of pleasure, contentment, or joy. Indicates positive emotions like cheerfulness, delight, gratitude, optimism, or satisfaction.

2. Sadness: A feeling of unhappiness, grief, or sorrow. Indicates emotions like disappointment, despair, gloom, loneliness, or regret.

3. Anger: A strong feeling of annoyance, displeasure, or hostility. Indicates emotions like frustration, irritation, rage, resentment, or contempt.

4. Fear: An unpleasant emotion caused by the threat of danger, pain, or harm. Indicates emotions like anxiety, dread, nervousness, terror, or worry.

5. Surprise: A feeling of astonishment or shock caused by something unexpected. Indicates emotions like amazement, bewilderment, or disbelief.

6. Disgust: A feeling of revulsion or strong disapproval. Indicates emotions like aversion, distaste, repulsion, or loathing.
...
Respond with only one of these seven emotion categories based on the most dominant emotion present in the text.
