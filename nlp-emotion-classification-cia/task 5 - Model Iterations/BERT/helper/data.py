...
class EmolexFeatureExtractor:
    ...
    def __init__(self, lexicon_path="./features/EmoLex/NRC-Emotion-Lexicon-Wordlevel-v0.92.txt"):
        """
...
class FeatureExtractor:
    ...
    def __init__(self, feature_config=None, lexicon_path="./features/EmoLex/NRC-Emotion-Lexicon-Wordlevel-v0.92.txt"):
...
class DataPreparation:
    ...
    def prepare_data(self, train_df, test_df=None, validation_split=0.2):
        """
