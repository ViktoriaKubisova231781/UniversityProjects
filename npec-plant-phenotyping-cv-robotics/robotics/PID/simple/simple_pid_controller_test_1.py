...
def run_trial_pid(target, dt=1.0, max_steps=1000, threshold=0.001, hold_steps=50):
    ...
    pid_x = PIDController(10, 0, 0)
    pid_y = PIDController(10, 0, 0)
    pid_z = PIDController(10, 0, 0)
    ...
    with open("simple_pid_results_1.csv", mode="w", newline="") as file:
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("simple_pid_position_plot_1.png")
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("simple_pid_distance_plot_1.png")
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("simple_pid_error_plot_1.png")
    plt.show()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("simple_pid_velocity_plot_1.png")
    plt.show()
